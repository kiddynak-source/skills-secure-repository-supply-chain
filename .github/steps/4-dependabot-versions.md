...
<img width="955" alt="axios の PR がマージされ、他の 2 件が閉じられたことを示すスクリーンショット" src="https://github.com/kiddynak-source/skills-secure-repository-supply-chain/blob/main/.github/images/axios-pr-merged-others-closed.png?raw=true" />
